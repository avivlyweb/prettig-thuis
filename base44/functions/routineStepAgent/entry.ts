...
const ROUTINE_STEPS = {
  ...
  toileting: {
    title: { nl: "Naar het toilet", en: "Using the Toilet" },
    icf_code: "d530",
    steps: {
      nl: [
        "U gaat even naar het toilet. Dat is heel normaal. Ik help u rustig.",
        "Loop langzaam naar het toilet. Neem uw tijd, er is geen haast.",
        "Zet uw handen op de steunen als die er zijn.",
        "Laat u rustig zakken op het toilet. Goed zo.",
        "Neem de tijd. U bent veilig hier.",
        "Als u klaar bent, pak dan het toiletpapier.",
        "Sta rustig op. Houd u goed vast.",
        "Was daarna even uw handen. Dat is fijn en gezond.",
      ],
      en: [
        "You're going to the toilet. That's completely normal. I'll guide you gently.",
        "Walk slowly to the toilet. Take your time, there's no rush.",
        "Place your hands on the support rails if there are any.",
        "Lower yourself gently onto the toilet. Well done.",
        "Take your time. You are safe here.",
        "When you're ready, reach for the toilet paper.",
        "Stand up slowly. Hold on firmly.",
        "Then wash your hands. That feels good and keeps you healthy.",
      ],
    },
  },
  eating: {
    title: { nl: "Eten en drinken", en: "Eating & Drinking" },
    icf_code: "d550",
    steps: {
      nl: [
        "Het is tijd om te eten. Goed voor uzelf zorgen begint hiermee.",
        "Ga rustig aan tafel zitten. Neem een comfortabele houding.",
        "Kijk eens wat er op uw bord ligt. Ruik het eens. Ziet het er lekker uit?",
        "Neem een kleine hap. Kauw rustig en geniet ervan.",
        "Neem ook af en toe een slokje water of thee.",
        "U hoeft niet alles op te eten. Eet wat goed voelt.",
        "Heeft u genoeg gehad? Dat is prima. U heeft goed gedaan.",
      ],
      en: [
        "It's time to eat. Taking care of yourself starts here.",
        "Sit down at the table comfortably. Take a relaxed position.",
        "Have a look at what's on your plate. Give it a smell. Does it look nice?",
        "Take a small bite. Chew slowly and enjoy it.",
        "Take a sip of water or tea every now and then.",
        "You don't have to finish everything. Eat what feels right.",
        "Had enough? That's perfectly fine. You've done well.",
      ],
    },
  },
  walking: {
    title: { nl: "Even bewegen", en: "A Little Walk" },
    icf_code: "d450",
    steps: {
      nl: [
        "We gaan even een stukje lopen. Beetje bewegen doet u goed.",
        "Sta rustig op. Houd u vast totdat u goed in evenwicht staat.",
        "Voel u stevig staan? Goed zo. We beginnen langzaam.",
        "Zet één voet voor de andere. Rustig aan, geen haast.",
        "Kijk even om u heen. Geniet van wat u ziet.",
        "U doet het heel goed. Nog een stukje als u wilt.",
        "Wilt u even rusten? Zoek een stoel of bankje in de buurt.",
        "Goed gedaan! Bewegen is zo belangrijk. U mag trots op uzelf zijn.",
      ],
      en: [
        "Let's go for a short walk. A bit of movement will do you good.",
        "Stand up slowly. Hold on until you feel steady.",
        "Feeling stable? Great. We'll start nice and slowly.",
        "Put one foot in front of the other. No rush at all.",
        "Look around you. Take in what you see.",
        "You're doing wonderfully. A little further if you'd like.",
        "Would you like to rest? Find a chair or bench nearby.",
        "Well done! Movement matters so much. You should be proud of yourself.",
      ],
    },
  },
  light_housework: {
    title: { nl: "Helpen in huis", en: "Helping Around the House" },
    icf_code: "d640",
    steps: {
      nl: [
        "U gaat een klein klusje doen. Dat geeft een goed gevoel.",
        "We beginnen eenvoudig. Pakt u de doek of het vaatdoekje?",
        "Wrijf rustig over het tafelblad of het aanrecht.",
        "Vouwt u daarna een handdoek of theedoek op? In drieën is prima.",
        "Zet de gevouwen doek op de vaste plek. Precies goed.",
        "Kijk eens wat u gedaan heeft. Netjes toch?",
        "U heeft echt geholpen vandaag. Dank u wel.",
      ],
      en: [
        "You're going to do a small task. That always feels good.",
        "Let's start simply. Can you pick up the cloth or tea towel?",
        "Gently wipe the table surface or the countertop.",
        "Now fold a towel or tea towel. Into thirds is perfect.",
        "Put the folded towel in its usual place. Just right.",
        "Look at what you've done. Tidy, isn't it?",
        "You really helped today. Thank you so much.",
      ],
    },
  },
};
